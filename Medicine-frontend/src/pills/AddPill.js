...
export default function AddPill() {
    ...
    const onSubmit =async (e) => {
        e.preventDefault();
        await axios.post("http://localhost:8080/pill",pill);
        swal({
            title: "Success!",
            text: "Pill Added successfully!",
            icon: "success",
            button: "OK!",
        });
        navigate("/pill");
  ...
  return (
    ...
    <div className='container' style={{paddingTop: '12rem', paddingBottom: '10rem'}}>
        <h2 className="page-section-heading text-center text-uppercase text-secondary mb-0">Add Pill</h2>
